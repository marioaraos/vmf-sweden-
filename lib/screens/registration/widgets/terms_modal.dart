...
class _TermsAndConditionsModalState extends State<TermsAndConditionsModal> {
  ...
  int _currentPage = 0;
  final int _totalPages = 6; // Incrementado para cubrir ambas políticas
            ...
            Expanded(
              child: PageView(
                ...
                children: [
                  ...
                  // PÁGINA 3: PRIVACIDAD - RECOPILACIÓN
                  _buildPage(
